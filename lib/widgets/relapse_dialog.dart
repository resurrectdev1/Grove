...
class RelapseDialog extends StatefulWidget {
  ...
  final void Function(String reason, DateTime customTimestamp)
  onCustomRelapseConfirm;
  const RelapseDialog({
    super.key,
    required this.habitName,
    required this.onCustomRelapseConfirm,
  });
  @override
