...
class _HabitCardState extends State<HabitCard> {
  ...
  void _showRerollTreeShapeDialog(
    BuildContext ctx,
    HabitTree habit,
    GroveTheme theme,
    AppLocalizations l10n,
...
class _OptionsMenuButton extends StatelessWidget {
  ...
  final VoidCallback? onToggleExcusedDaysCount;
  final VoidCallback? onRerollTreeShape;
  ...
  const _OptionsMenuButton({
    ...
    this.onToggleExcusedDaysCount,
    this.onRerollTreeShape,
    this.iconSize = 20,
  });
  ...
  Future<void> _openMenu(BuildContext context) async {
    ...
    switch (value) {
      ...
      case 'color':
        onChangeColor();
        break;
      case 'excusedDaysCount':
        onToggleExcusedDaysCount?.call();
        break;
      case 'rerollTreeShape':
        onRerollTreeShape?.call();
        break;
      case 'delete':
        onDelete();
        break;
