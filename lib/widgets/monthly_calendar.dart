      ...
      child: Column(
        ...
        children: [
                ...
                (weekIndex) => Expanded(
                  child: Row(
                    children: List.generate(7, (dayIndex) {
                      ...
                      final hasCheckIn =
                          isCheckIn && habit.checkInDays.contains(cellDate);
                      final hasNullDay =
                          isCheckIn && habit.nullDays.contains(cellDate);
                      final hasMark = isCheckIn
                          ? (hasCheckIn || hasNullDay)
                          : hasRelapse;
                      ...
                      final cellColor = isFuture
                          ...
                          ? (isCheckIn
                                ...
                                : GroveTheme.clayRed.withValues(alpha: 0.7))
                          : theme.surfaceHigh;
          ...
          Row(
            ...
            children: [
              _legendDot(theme.surfaceHigh),
              const SizedBox(width: 5),
              Text(
                isCheckIn ? l10n.legendMissed : l10n.legendAbstained,
              ...
              const SizedBox(width: 5),
              Text(
                isCheckIn ? l10n.legendCheckIn : l10n.legendRelapse,
                style: TextStyle(fontSize: 9, color: theme.textMuted),
              ),
              if (isCheckIn) ...[
                const SizedBox(width: 14),
...
class _CellManagerSheetState extends State<_CellManagerSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasMark = _isCheckIn
        ? widget.habit.checkInDays.contains(
            DateTime(
              widget.targetDate.year,
              widget.targetDate.month,
              widget.targetDate.day,
          ...
          children: [
            ...
            if (!_isCheckIn) ...[
              ...
              OutlinedButton.icon(
                ...
                label: Text(
                  l10n.anchorTime(_selectedTime.format(context)),
              ...
              Text(
                hasMark ? l10n.editReason : l10n.reasonOptional,
                style: TextStyle(
                  color: theme.textMuted,
                  fontSize: 11,
                  letterSpacing: 0.5,
            ...
            if (_isCheckIn) ...[
              ...
              if (!widget.hasNullDay) ...[
                ...
                OutlinedButton.icon(
                  ...
                  icon: const Icon(Icons.access_time, size: 14),
                  label: Text(
                    l10n.checkInTimeLabel(_selectedTime.format(context)),
                    style: const TextStyle(fontSize: 13),
                  ),
                  style: OutlinedButton.styleFrom(
                    foregroundColor: theme.textPrimary,
              ...
              if (!widget.hasNullDay) ...[
                if (hasMark) ...[
                  OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      side: BorderSide(
                        color: widget.habit.color.withValues(alpha: 0.45),
                      ),
                ...
                FilledButton.icon(
                  onPressed: () {
                    if (hasMark) {
                      widget.model.removeCheckInOnDate(
                        widget.habit.id,
                        widget.targetDate,
                      );
                    } else {
                  ...
                  label: Text(
                    hasMark ? l10n.removeCheckIn : l10n.checkInThisDay,
                    style: TextStyle(
                      color: hasMark ? theme.textPrimary : Colors.white,
                    ),
                  ),
                ...
                OutlinedButton.icon(
                  onPressed: () {
                    widget.model.toggleNullDay(
                      widget.habit.id,
                      widget.targetDate,
                    );
                    widget.model.setNullDayNote(
                      widget.habit.id,
                      widget.targetDate,
                      _noteCtrl.text,
                    );
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(
                      color: const Color(0xFF42A5C8).withValues(alpha: 0.45),
                    ),
                    minimumSize: const Size.fromHeight(48),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(12),
              ...
              FilledButton.icon(
                onPressed: () {
                  ...
                  widget.model.recordCustomRelapse(
                    widget.habit.id,
              ...
              OutlinedButton.icon(
                onPressed: () {
                  widget.model.removeRelapseOnDate(
                    widget.habit.id,
                    widget.targetDate,
                  );
                  HapticFeedback.lightImpact();
                ...
                style: OutlinedButton.styleFrom(
                  ...
                  side: BorderSide(
                    color: GroveTheme.clayRed.withValues(alpha: 0.4),
                  ),
                  minimumSize: const Size.fromHeight(48),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(12),
