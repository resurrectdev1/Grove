...
class TimeDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Text(
    ':',
    style: TextStyle(fontSize: 24, fontWeight: FontWeight.w300, color: color),
  );
}
...
class EarlierDateSentinel extends StatelessWidget {
  ...
  final VoidCallback onLogEarlierDate;
  const EarlierDateSentinel({
    super.key,
    required this.habit,
    required this.theme,
    required this.onLogEarlierDate,
  });
        ...
        children: [
          ...
          Text(
            l10n.trackingStarted(
              DateFormat('MMM d, yyyy').format(habit.startDate),
            ),
            style: TextStyle(
              fontSize: 12,
