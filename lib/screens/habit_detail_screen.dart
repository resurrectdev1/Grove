...
class _HabitDetailScreenState extends State<HabitDetailScreen> {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
            ...
            habit.relapses.isEmpty
                ...
                : SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (_, i) =>
                          RelapseEventTile(event: habit.relapses[i], index: i),
                      childCount: habit.relapses.length,
                    ),
                  ),
          ] else ...[
            SliverToBoxAdapter(
              child: _checkInHistoryHeader(habit, theme, l10n),
            ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: isExcused
                                    ? frostColor.withValues(alpha: 0.14)
                                    ...
                                    children: [
                                      ...
                                      if (isExcused)
                                        ...
                                        Text(
                                          DateFormat(
                                            'h:mm a',
                                          ).format(habit.checkInTimeFor(day)),
                                          style: TextStyle(
                                            fontSize: 11,
          ...
          SliverToBoxAdapter(
            child: _deleteSection(context, habit, theme, l10n),
          ),
  ...
  Widget _timeSinceRelapseCard(
    ...
    final label = habit.relapses.isEmpty
        ? l10n.abstinentSinceStart
        : l10n.timeSinceLastRelapse;
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Text(
              checkedIn ? l10n.checkedInToday : l10n.notCheckedInToday,
              style: TextStyle(
                fontSize: 11,
                fontWeight: FontWeight.w600,
                color: theme.textSecondary,
        ...
        child: IconButton(
          ...
          icon: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: habit.color.withValues(alpha: 0.6),
                  blurRadius: 6,
                ),
              ],
            ),
        ...
        return SizedBox(
          ...
          child: Stack(
            children: [
              ...
              Positioned(right: 12, bottom: 4, child: _treeActionBar(habit)),
            ],
          ),
        );
      },
  ...
  Widget _treeActionBar(HabitTree habit) {
    final theme = context.watch<GroveSettings>().theme;
    return _treeActionButton(
      icon: Icons.ios_share_rounded,
      tooltip: 'Share snapshot',
      theme: theme,
      onTap: () => showTreeShareSheet(context, habit: habit, theme: theme),
    );
  }

  Widget _treeActionButton({
  ...
  Widget _stats(HabitTree habit, GroveTheme theme, AppLocalizations l10n) =>
      Padding(
        ...
        child: Row(
          children: [
            StatChip(
              ...
              value: l10n.daysSuffix(habit.daysElapsed),
              color: habit.color,
            ),
            const SizedBox(width: 10),
            StatChip(
              label: l10n.peakRecord,
              value: l10n.daysSuffix(habit.peakDays),
              color: GroveTheme.streakGold,
            ),
            const SizedBox(width: 10),
            StatChip(
              label: habit.mode == HabitMode.checkIn
                  ? l10n.checkIns
                  : l10n.relapses,
              value: habit.mode == HabitMode.checkIn
                  ? '${habit.checkInDays.length}'
                  : '${habit.relapses.length}',
              color: habit.mode == HabitMode.checkIn
                  ? habit.color
                  : GroveTheme.clayRed,
            ),
          ],
          ...
          SizedBox(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (_, index) {
                ...
                if (index == 0) {
                  return EarlierDateSentinel(
                    habit: habit,
                    theme: theme,
                    onLogEarlierDate: () =>
                        _showEarlierDatePicker(context, habit),
                  );
                }
            ...
            child: Text(
              _currentMonthOffset == -_initialPageIndex
                  ...
                  : DateFormat('MMMM yyyy').format(
                      DateTime(now.year, now.month + _currentMonthOffset, 1),
                    ),
              style: TextStyle(
                fontSize: 10,
                color: theme.textMuted,
      ...
      builder: (sheetCtx) => StatefulBuilder(
        builder: (builderCtx, setSheet) {
          final bottomPad = math.max(
            MediaQuery.of(builderCtx).viewInsets.bottom,
            MediaQuery.of(builderCtx).padding.bottom,
          );
          return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        height: 40,
                        decoration: BoxDecoration(
                          color: GroveTheme.clayRed.withValues(alpha: 0.12),
                          borderRadius: BorderRadius.circular(12),
                        ),
                        child: const Icon(
                  ...
                  OutlinedButton.icon(
                    onPressed: () async {
                      final picked = await showDatePicker(
                        ...
                        lastDate: habit.startDate.subtract(
                  ...
                  OutlinedButton.icon(
                    ...
                    label: Text(
                      selectedTime.format(builderCtx),
                      style: const TextStyle(fontSize: 13),
                    ),
                    style: OutlinedButton.styleFrom(
                      foregroundColor: theme.textPrimary,
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: l10n.whatHappenedHint,
    ...
    child: Row(
      children: [
        ...
        Container(
          ...
          child: Text(
            l10n.totalCount(habit.relapses.length),
  ...
  Widget _noHistory(
    ...
    child: Center(
      child: Text(
        checkIn ? l10n.noCheckInsYet : l10n.noRelapsesRecorded,
        style: TextStyle(
          color: theme.textMuted,
          fontStyle: FontStyle.italic,
          fontSize: 13,
    ...
    child: Row(
      children: [
        ...
        Container(
          ...
          child: Text(
            l10n.totalCount(habit.checkInDays.length + habit.nullDays.length),
            style: TextStyle(
              fontSize: 11,
              color: habit.color,
              fontWeight: FontWeight.w500,
